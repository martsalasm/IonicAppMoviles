...
app.post("/api/register", (req, res) => {
    ...
    const sql = `INSERT INTO users (usuario, nombre, apellido, nivelEducacion, fechaNacimiento, contrasena) 
                 VALUES (?, ?, ?, ?, ?, ?)`;

    db.run(
        sql,
        [usuario, nombre, apellido, nivelEducacion, fechaNacimiento, contrasena],
        function (err) {
            if (err) {
